...
import { viewerName, repositoryUrl } from '../../viewerInfo'
...
export default function InfoSection () {
  ...
  return <div>
    ...
    <TabPanel {...tab} stopId='general' className={styles.panel}>
      ...
      <p>This viewer is developed and run as a personal project.</p>

      <p>
        Keeping your personal information save and private is important to me.
        Thats why everything is encrypted!
        <button type='button' onClick={() => { tab.move('encryption') }}>Read more</button>
      </p>
    </TabPanel>
