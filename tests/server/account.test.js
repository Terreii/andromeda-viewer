...
describe('account', function () {
      ...
      await request(server)
        ...
        .expect(() => {
          ...
          assert.deepStrictEqual(
            usersDbCreateIndex.firstCall.firstArg,
            {
              index: {
                fields: ['email'],
              },
  ...
  describe('PUT', function () {
    it('should create a new account', async function () {
      ...
      assert.ok(
        res.body.links.self.endsWith('/api/account'),
        'has a link to self'
      );
      ...
      assert.strictEqual(userDoc.password, PASSWORD);
      ...
      assert.ok(
        uuid.validate(userDoc.email_validation),
        'email validation is an UUID'
      );
    });
